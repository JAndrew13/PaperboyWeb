<template>
  <div class="financial-analysis-table">
    ...
    <v-row cols="auto">
      ...
      <v-col cols="12" md="6" lg="4">
        <AccountValueCard :accounts="accounts"></AccountValueCard>
      </v-col>

      <v-col cols="12" md="6" lg="4">
        <OverviewStatsCard :accounts="accounts"></OverviewStatsCard>
      </v-col>
    </v-row>
</v-sheet>
</div>
  ...
  export default defineComponent({
    ...
    components: { AccountValueCard, OverviewStatsCard }
});
